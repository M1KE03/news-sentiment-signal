...
**No text has been scored, no labels have been collected, no panel has been built, no model has been fitted, and no Act 1 or Act 2 result exists.** The remaining dependency for Act 1 is a **named annotator**; the pilot worksheet is prepared and the user has volunteered to label it. The Loughran-McDonald dictionary is acquired and verified, and Smart App Control no longer blocks torch, so neither is a blocker any more.
